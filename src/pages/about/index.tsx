  ...
  const expertise = [
    {
      ...
      description:
        "When disaster strikes, every minute counts. Our team arrives within 60 minutes, fully equipped to begin water extraction immediately. No delays, no excuses.",
      icon: AlertTriangle,
      highlight: true,
    },
    {
      ...
      description:
        "Our investment in cutting-edge equipment means faster water removal, more efficient drying, and better protection for your property.",
      icon: Wrench,
    },
    {
      title: "Certified & Insured",
      description:
        "Every team member is certified in water damage restoration and covered by comprehensive insurance. Your property is in safe hands.",
      icon: Shield,
    },
    {
      title: "Transparent Process",
      description:
        "From initial assessment to final restoration, you&apos;ll receive clear documentation and real-time updates throughout the entire process.",
      icon: BadgeCheck,
    },
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-24 sm:py-32">
          <div className="max-w-3xl">
            ...
            <p className="text-xl md:text-2xl text-stone-300 mb-8">
              Brooklyn&apos;s dedicated water damage specialists. Fast response,
              modern solutions, guaranteed results.
            </p>
            ...
            {expertise.map((item, index) => (
              <div
                ...
                className={`p-8 rounded-xl ${
                  item.highlight ? "bg-[#1C1917] text-white" : "bg-stone-100"
                }`}
              >
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-8">
              <div>
                ...
                <p className="text-stone-600">
                  We guarantee a 60-minute response time for emergency calls
                  anywhere in Brooklyn. Our teams are strategically positioned
                  to reach you fast.
                </p>
              </div>
              <div>
                ...
                <p className="text-stone-600">
                  Yes, our team holds all required certifications in water
                  damage restoration, and we maintain comprehensive insurance
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-stone-600">
                  We service all Brooklyn neighborhoods, 24/7. From Williamsburg
                  to Brighton Beach, we&apos;re there when you need us.
                </p>
              </div>
              <div>
                <h3 className="text-xl font-bold mb-2">
                ...
                <p className="text-stone-600">
                  Our emergency response protocol includes immediate water
                  extraction, damage assessment, and the deployment of
