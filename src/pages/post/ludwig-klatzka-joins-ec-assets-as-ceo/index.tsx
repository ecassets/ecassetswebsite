...
const Post = () => {
  return (
    <>
      <Head>
        <title>Ludwig Klatzka joins EC Assets as CEO | EC Assets</title>
        <meta
          name="description"
          content="EC Assets today announced that Ludwig Klatzka has joined the firm as CEO and head of EC's Private Equity (PE) division based in Luxembourg."
        />
      </Head>
        ...
        <section className="relative w-full">
          <div className="relative h-[500px] bg-gray-800">
            <Image
              ...
              alt="Ludwig Klatzka joins EC Assets as CEO"
              fill
            ...
            <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
              <div className="container mx-auto px-4 text-center text-white">
                <h1 className="text-5xl font-light mb-4">
                  Ludwig Klatzka joins EC Assets as CEO
                </h1>
        ...
        <main className="container mx-auto px-4 py-12">
          <div className="prose max-w-none">
            <p className="text-xl mb-8">
              EC Assets today announced that Ludwig Klatzka has joined the firm
              as CEO and head of EC&apos;s Private Equity (PE) division based in
              Luxembourg.
            </p>
            ...
            <p className="mb-8">
              EC Assets has been expanding its PE devision since 2015, and the
              addition of Ludwig to our talented team augments our abilities
              across the full spectrum of strategic M&A.
            </p>
            ...
            <p className="mb-8">
              Ludwig is excited to join the team at a time when the private
              equity industry is set to continue breaking records on deal values
              and volume. Working thoroughly and forward-thinking, he is focused
              on delivering the right resources to best execute our transactions
